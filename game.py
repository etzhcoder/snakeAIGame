...
pygame.init()
#sets the font
font = pygame.font.Font('space_invaders.ttf', 25)

#functions needed
# reset the game every time
# implement reward system
# change input so that it takes play(action) (an action) and converts it into a direction
# keep track of the current generation
# is_collision has to change
